...
HD_PWD='/media/sf_6.111/dumpet/dumpet.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cart_interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cart_interface.tcl

...
#
# Generated by export_simulation on Fri Nov 12 14:59:01 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './bram_hram.sh' script.

./bram_hram.sh -reset_run
...
./bram_hram.sh -noclean_files

For more information on the script, please type './bram_hram.sh -help'.
